...
namespace Application.Ports.Input
{
    public interface IProductService
    {
        ...
        Task<PagedResult<ProductResponseDto>> GetFilteredAsync(ProductFilterDto filterDto, CancellationToken cancellationToken = default);
        Task<IEnumerable<ProductBatchDto>> GetBatchAsync(IEnumerable<Guid> productIds, CancellationToken cancellationToken = default);
        IEnumerable<string> GetCategoriesAsync(CancellationToken cancellationToken = default);
